...
class Experiment:
    ...
    def train_and_evaluate_model(self, model_name, X_resampled, y_resampled, datascaler, replication):
        ...
        accuracy, f1, roc_auc, predictions, balanced = trainer.evaluate(X_test, y_test)

        self.store_results(model_name, replication, accuracy, f1, roc_auc, best_params, balanced)
    ...
    def store_results(self, model_name, replication, accuracy, f1, roc_auc, best_params, balanced):
        ...
        logging.info(
            ...
            f"ROC AUC: {roc_auc:.4f}, Params: {best_params}, balanced: {balanced}")
